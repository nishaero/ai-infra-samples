...
class TestEndToEndPipeline:
    ...
    def test_complete_pipeline(self, temp_workspace):
        ...
        print(
            f"  Processed dataset: {len(df)} samples, {len(features)} features"
        )  # noqa: E501
        ...
        predictor = SimpleClimatePredictor(
            model_dir=str(temp_workspace["model_dir"]), random_state=42
        )
        ...
        print(
            f"  Training completed. Ensemble MAE: {training_results['ensemble_scores']['val_mae']:.3f}"  # noqa: E501
        )
        ...
        new_predictions = new_predictor.predict(
            X.head(10)
        ...
        if feature_importance:
            for model_name, importance in feature_importance.items():
                ...
                # Check that importances are non-negative and sum to reasonable value  # noqa: E501
                assert all(imp >= 0 for imp in importance)
                print(
                    f"  {model_name}: top feature importance = {importance.max():.3f}"  # noqa: E501
                )
    ...
    def test_trainer_integration(self, temp_workspace):
        ...
        print(
            f"Training completed: Test MAE = {results['test_metrics']['mae']:.3f}"  # noqa: E501
        )  # noqa: E501
    ...
    def test_data_pipeline_consistency(self, temp_workspace):
        ...
        # Verify consistency (since we use random seed, results should be similar)  # noqa: E501
    ...
    def test_model_performance_threshold(self, temp_workspace):
        ...
        # Generate data
        bbox = (-120, 35, -115, 40)
        client.fetch_climate_data("2023-01-01", "2023-01-15", bbox)
        ...
        print(
            f"Performance thresholds met: MAE={ensemble_mae:.3f}, R²={ensemble_r2:.3f}"  # noqa: E501
        )
