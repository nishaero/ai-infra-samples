...
class TestNOAAClimateDataClient:
    ...
    def test_fetch_temperature_data(self, client):
        ...
        df = client.fetch_temperature_data(
    ...
    def test_data_file_creation(self, client, temp_dir):
        ...
        expected_file = Path(temp_dir) / "noaa_temperature_2023-01-01_2023-01-02.csv"
    ...
    def test_fallback_data_generation(self, client):
        ...
        # Should have seasonal variation (January should be cooler in Northern Hemisphere)
